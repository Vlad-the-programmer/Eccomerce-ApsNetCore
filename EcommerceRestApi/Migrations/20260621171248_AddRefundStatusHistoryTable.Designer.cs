...
namespace EcommerceRestApi.Migrations
{
    ...
    [Migration("20260621171248_AddRefundStatusHistoryTable")]
    partial class AddRefundStatusHistoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceRestApi.Models.DeliveryMethodOrder", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrderId" }, "IX_DeliveryMethodOrders_OrderId");
            ...
            modelBuilder.Entity("EcommerceRestApi.Models.InvoiceItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "InvoiceId" }, "IX_InvoiceItem_InvoiceId");

                    b.HasIndex(new[] { "ProductId" }, "IX_InvoiceItem_ProductId");
            ...
            modelBuilder.Entity("EcommerceRestApi.Models.OrderItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderIte__3214EC07ABC16B2E");
            ...
            modelBuilder.Entity("EcommerceRestApi.Models.Shipment", b =>
                {
                    ...
                    b.HasIndex(new[] { "DeliveryMethodId" }, "IX_Shipments_DeliveryMethodId");

                    b.HasIndex(new[] { "OrderId" }, "IX_Shipments_OrderId");
            ...
            modelBuilder.Entity("EcommerceRestApi.Models.Refund", b =>
                {
                    b.HasOne("EcommerceRestApi.Models.Customer", null)
                        .WithMany("Refunds")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
